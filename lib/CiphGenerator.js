...
const allowAlgorithms = ['aes-256-ctr', 'aes-256-cbc', 'aes-256-ofb', 'aes-256-cfb'];
...
function Decipher (cipherText, cipherKey) {
  ...
  if (!encrypedHex || !ivHex) throw new Error('[CiphCrypt] malformed hash provided; example: `encrypted:iv');
